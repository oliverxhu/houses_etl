...
class Listings(ETLTools.ETLTools):
    ...
    def update_rental_listings(self, table='rental_listings'):
        ...
        # staging_listings_df['start_date'] = staging_listings_df['start_date'].astype('datetime64[s, UTC]')
        # staging_listings_df['end_date'] = staging_listings_df['end_date'].astype('datetime64[s, UTC]')
